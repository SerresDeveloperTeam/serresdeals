                        ...
                        <div class="modal-body" style="padding:40px 50px;">
                            <form role="form">
                                <div class="form-group">
                                    <label for="usrname">Όνομα Χρήστη</label>
                                    <input type="text" class="form-control" id="usrname" placeholder="Εισάγετε το email σας">
                                </div>
                                <div class="form-group">
                                    <label for="psw">Κωδικός Πρόσβασης</label>
                                    <input type="text" class="form-control" id="psw" placeholder="Εισάγετε τον κωδικό σας">
                                </div>
